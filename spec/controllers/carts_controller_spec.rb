  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved cart as @cart" do
        ...
        post :create, {:cart => { "customer" => "invalid value" }}, valid_session
        assigns(:cart).should be_a_new(Cart)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested cart" do
        ...
        Cart.any_instance.should_receive(:update_attributes).with({ "customer" => "" })
        put :update, {:id => cart.to_param, :cart => { "customer" => "" }}, valid_session
      end
